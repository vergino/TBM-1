...
<head>
  ...
  <title>Funeral Flower - True Blossom Mart</title>
...
<body>
  ...
  <main class="product-container">
    ...
    <div class="product-card">
      ...
      <div class="product-details">
        <h1 class="product-title">FUNERAL FLOWER</h1>
        <div class="rating">★★★★★ <span>5.0</span></div>
        <div class="events"><span>Funeral</span></div>
        ...
        <div class="description">
          <h3>DETAILS</h3>
          <p> A thoughtful funeral flower arrangement, known for its soft, comforting presence that brings peace to any memorial setting. Perfect for honoring a loved one’s memory, this floral tribute is a symbol of remembrance and heartfelt sympathy. Carefully arranged to express respect and grace, it serves as a meaningful gesture to offer comfort during times of grief and as a gentle reminder of a life beautifully lived.</p>
        </div>
      ...
      <div class="reviews">
		...
		<div class="individual-review">
			<img src="../../../assets/users/user_CM.png" class="reviewer-profile-pic" alt="Clarence Manalo">
			<p><strong>Ayesha Banzado</strong> ★★★★★<br>A gentle way to say goodbye.</p>
		</div>
		</div>
  ...
  <script>
  const productName   = "FUNERAL FLOWER";
  const productPrice  = "₱1,900";
