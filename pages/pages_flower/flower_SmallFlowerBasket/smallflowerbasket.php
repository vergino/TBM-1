...
<head>
  ...
  <title>Small Flower Basket - True Blossom Mart</title>
...
<body>
  ...
  <main class="product-container">
    ...
    <div class="product-card">
      ...
      <div class="product-details">
        <h1 class="product-title">SMALL FLOWER BASKET</h1>
        <div class="rating">
          ★★★★★ <span>5.0%</span>
        </div>
        <div class="events">
      ...
      <div class="reviews">
		...
		<div class="individual-review">
			<img src="../../../assets/users/user_SC.jpg" class="reviewer-profile-pic" alt="Shane Castillo">
			<p><strong>Shane Castillo</strong> ★★★★★<br>My friend absolutely adored this as a birthday gift!</p>
		</div>
		</div>
  ...
  <script>
    const productName = "SMALL FLOWER BOUQUET";
