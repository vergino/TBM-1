...
<head>
  ...
  <title>Vased Rose - True Blossom Mart</title>
...
<body>
  ...
  <main class="product-container">
    ...
    <div class="product-card">
      <div class="product-image">
        <img src="https://media.istockphoto.com/id/111795740/photo/bouquet-of-red-roses.jpg?s=612x612&w=0&k=20&c=PFz1-TC_64jMyPMvgiSWpeqmTNdwXmDupOPpnUDLtnc=" alt="Rose Bunch">
      </div>
      <div class="product-details">
         <h1 class="product-title">VASED ROSE</h1>
        ...
        <div class="description">
          <h3>DETAILS</h3>
          <p>
            A charming vased rose arrangement, radiating warmth and love to celebrate the sweetest moments. Perfect for expressing affection,
             admiration, and appreciation, these roses symbolize beauty, joy, and lasting memories. Thoughtfully arranged with care, they make a heartfelt gesture, a lovely reminder of the love and happiness shared.
          </p>
        </div>
      ...
      <div class="reviews">
		...
		<div class="individual-review">
			<img src="../../../assets/users/user_FS.png" class="reviewer-profile-pic" alt="Clarence Manalo">
			<p><strong>Felicia Salazar</strong> ★★★★★<br>This is drop dead GORGEOUS!!!</p>
		</div>
		</div>
  ...
  <script>
    const productName = "VASED ROSE";
    const productPrice = "₱1,500";
