...
<head>
  ...
  <title>Rose Bunch - True Blossom Mart</title>
...
<header class="tbmHeader">
  ...
  <main class="product-container">
    ...
    <div class="product-card">
      ...
      <div class="product-details">
         <h1 class="product-title">ROSE BUNCH</h1>
        ...
        <div class="description">
          <h3>DETAILS</h3>
          <p>
            A stunning bouquet of fresh, hand-picked roses, perfect for valentines and even anniversary day!
            Carefully arranged to express love, gratitude, or celebration, this rose bunch adds a touch of elegance and romance to any moment.
          </p>
        </div>
      ...
      <div class="reviews">
		...
		<div class="individual-review">
			<img src="../../../assets/users/user_FD.jpg" class="reviewer-profile-pic" alt="Florence Dizon">
			<p><strong>Florence Dizon</strong> ★★★★★<br>My girlfriend enjoyed it so much that she plans to introduce me to her parents!</p>
		</div>
  ...
  <script>
  const productName = "ROSE BUNCH";
  const productPrice = "₱1,200";
