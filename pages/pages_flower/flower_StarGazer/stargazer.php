...
<head>
  ...
  <title>Stargazer - True Blossom Mart</title>
...
<body>
  ...
  <main class="product-container">
    ...
    <div class="product-card">
      <div class="product-image">
        <img src="https://down-ph.img.susercontent.com/file/ddf44abe0e2cd18cae9af60b1311c2e2" alt="Rose Bunch">
      </div>
      <div class="product-details">
        <h1 class="product-title">STARGAZER</h1>
        ...
        <div class="description">
          <h3>DETAILS</h3>
          <p>
            This small flower basket offers a gentle expression of care and remembrance. With its soft, calming blooms, it brings a quiet sense of peace to any memorial space. Thoughtfully arranged,
            it’s a heartfelt way to honor the memory of someone special—offering warmth, sympathy, and a comforting presence during a difficult time.
          </p>
        </div>
     ...
     <div class="action-buttons">
      ...
      <div class="reviews">
		...
		<div class="individual-review">
			<img src="../../../assets/users/user_MA.jpg" class="reviewer-profile-pic" alt="Marcus Anthony">
			<p><strong>Marcus Anthony</strong> ★★★★★<br>The stargazer is so dreamy and elegant! It's definitely the perfect anniversary gift!</p>
		</div>
		</div>
  ...
  <script>
    const productName = "STARGAZER";
    const productPrice = "₱1,529";
