...
<head>
  ...
  <title>Potted Hibiscus - True Blossom Mart</title>
...
<body>
  ...
  <main class="product-container">
    ...
    <div class="product-card">
      ...
      <div class="product-details">
        <h1 class="product-title">POTTED HIBISCUS</h1>
       ...
       <div class="quantity">
        ...
        <div class="description">
          <h3>DETAILS</h3>
          <p>
            A vibrant potted hibiscus, known for its large, colorful blooms that brighten up any space. Perfect for both indoor and outdoor settings,
            this plant is a symbol of beauty and positivity. Carefully nurtured to thrive with minimal care, it makes a thoughtful gift or a charming addition to your garden or home décor.
          </p>
        </div>
   ...
   <div class="reviews">
		...
		<div class="individual-review">
			<img src="../../../assets/users/user_KR.jpg" class="reviewer-profile-pic" alt="Kae Ross">
			<p><strong>Kae Ross</strong> ★★★★★<br>I gave this as a gift to my mother on Mother's Day, she absolutely LOVED IT!!!</p>
		</div>
		</div>
  ...
  <script>
    const productName = "POTTED HIBISCUS";
